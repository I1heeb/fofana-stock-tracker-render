            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="mr-4 text-right">
                    <div class="text-sm font-medium text-gray-700">
                        @auth
                            {{ auth()->user()->name }}
                            <span class="text-xs text-gray-500 ml-1">({{ auth()->user()->getRoleDisplayName() }})</span>
                        @else
                            Guest
                        @endauth
                    </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="px-4 mb-3">
                ...
                <select onchange="window.location.href=this.value" 
                    ...
                    <option value="{{ route('locale.switch', 'en') }}" {{ app()->getLocale() === 'en' ? 'selected' : '' }}>🇺🇸 English</option>
                    <option value="{{ route('locale.switch', 'fr') }}" {{ app()->getLocale() === 'fr' ? 'selected' : '' }}>🇫🇷 Français</option>
                    <option value="{{ route('locale.switch', 'ar') }}" {{ app()->getLocale() === 'ar' ? 'selected' : '' }}>🇸🇦 العربية</option>
                </select>
            </div>
            ...
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">
                    @auth
                        {{ auth()->user()->name }}
                        <span class="text-sm text-gray-500 ml-2">({{ auth()->user()->getRoleDisplayName() }})</span>
                    @else
                        Guest
                    @endauth
                </div>
