...
<head>
    ...
    <title>{{ config('app.name', 'Stock Tracker') }}</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Nunito:wght@300;400;500;600;700&display=swap" rel="stylesheet">
</head>
<body class="font-poppins antialiased bg-gray-50 min-h-screen">
        ...
        <div id="sidebar" class="hidden md:flex md:w-64 md:flex-col transition-all duration-300 ease-in-out">
            <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-navy-900 shadow-xl">
                ...
                <nav class="mt-8 flex-1 px-2 space-y-1">
                    ...
                    <!-- Admin/Users Button - Visible for admin users only -->
                    @can('admin-users')
                        <a href="{{ route('admin.users.index') }}" class="group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-200 {{ request()->routeIs('admin.*') ? 'bg-mustard-400 text-navy-900 shadow-lg' : 'text-gray-300 hover:bg-navy-800 hover:text-white' }}">
