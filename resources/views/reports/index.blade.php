...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-3xl font-bold text-navy-900">Reports</h2>
            <p class="text-gray-600 mt-1">Analytics and insights for your business</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="stats-card">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div class="w-14 h-14 bg-gradient-to-r from-navy-500 to-navy-600 rounded-xl flex items-center justify-center shadow-lg">
                ...
                <div class="ml-5 flex-1">
                    <dl>
                        ...
                        <dd class="text-3xl font-bold text-navy-900">{{ number_format($stats['total_orders']) }}</dd>
                    </dl>
                </div>
            </div>
        </div>
        ...
        <div class="stats-card">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div class="w-14 h-14 bg-gradient-to-r from-mustard-500 to-mustard-600 rounded-xl flex items-center justify-center shadow-lg">
